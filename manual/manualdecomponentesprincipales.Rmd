...
El metodo de Componentes Principales tiene por objeto reducir la dimensionalidad de un problema de m´ultiplesvariables, aplicando una sucesi´on de transformaciones lineales a las variables, de modo que un subconjunto deellas concentre la mayor parte de la variabilidad contenida en las variables originales.[@miscgalbiati2010componentes]
para poder ver 
